        ...
        <div className="container-fluid footer py-5">
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-md-6 col-lg-6 col-xl-4">
                        <div className="footer-item d-flex flex-column">
                            ...
                            <a href=""><i className="fas fa-envelope me-2"></i> citygoldpharmaceutical@gmail.com </a>
                            <a href=""><i className="fas fa-phone me-2"></i> +234 8069691653
</a>
                            <a href="" className="mb-3"><i className="fas fa-print me-2"></i> +234 8069691653
</a>
                ...
                <p style={{color:"white", textAlign: 'center'}}>
                    Physical address: No 30 court road, old Karu road Mararaba, Nasarawa state.
                </p>
            </div>
        </div>
        {/* <!-- Footer End --> */}
